    ...
    <div class="container text-center">
        ...
        <div class="d-flex justify-content-center">
            <form action="" method="post" class="w-50">
                <?php hiddenElement("hidden","id",""); ?>
                <div class="pt-2">
                    <?php inputElement("<i class='fas fa-book'></i>", "Book Name", "name", ""); ?>
                </div>
                <div class="row pt-2">
                    <div class="col">
                        <?php inputElement("<i class='fas fa-people-carry'></i>", "Publisher", "publisher", ""); ?>
                    </div>
                    <div class="col">
                ...
                if ($result) {
                    while ($row = mysqli_fetch_assoc($result)) { ?>
                        <tr>
                            ...
                            <td><i class="fas fa-trash btnDelete" data-id="<?php echo $row['id']; ?>"></i></td>
                        </tr>
                        <?php
                    }
                }
